...
const Home = () => {
  return (
    <Container className="col-xxl-8 px-4 py-5 my-5" id="scrollspyHeading1">
      <Row className="align-items-center g-5 py-5">
        ...
        <Col md={6} lg={6} xxl={6}>
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-start">
            <Button href="https://www.dropbox.com/s/od2z7ar04nofcyd/Joseph%20Scott%20Resume.pdf?dl=0" variant="outline-light btn-lg px-4">my resume</Button>
