      ...
      <Row className="align-items-center g-5 py-5">
        ...
        <Col md={6} lg={6} xxl={6}>
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-start">
            <Button href="https://www.dropbox.com/s/1oljdifvn3dnkze/Joseph%20Scott%20Resume.pdf?dl=0" variant="outline-light btn-lg px-4">my resume</Button>
            ...
            <Button variant="outline-light btn-lg px-4"><a href="mailto: joseph.b.scott.0@gmail.com" id="email">email</a></Button>
          </div>
        </Col>
      </Row>
    </Container>
